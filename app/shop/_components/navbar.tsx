...
export function Navbar() {
  return (
    <div
      className="animate-fadeInFromUp lg:w-[1800px] mt-1 lg:mt-2 lg:h-[128px] lg:px-[14px] relative px-4 border-sd h-[70px] font-lora flex justify-between items-center w-[100%]">
