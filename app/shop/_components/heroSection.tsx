...
export function HeroSection() {
  return <div>
    <div className="grid justify-center items-center pt-2 gap-1 pb-12">
    ...
    <div className="bg-[url('/dark_bg.png')] py-2 flex-col items-center px-4 gap-0 bg-[200px] border-t-[2px] border-gold">
      <div className="gap-1 flex justify-center items-center h-[120px]">
        <p className="text-[15px] font-mr font-semibold  text-center ">From chic streetwear to sophisticated elegance, we have the perfect outfit for every cahpter of your life.</p>
        <Image src='/clothes.png' className="h-[100px] w-auto" objectFit="contain" height={1586} width={1459} alt='bg' />
      </div>

      <div className="flex justify-center text-center animate-giggle">
