  ...
  return (
    <div className="bg-[url('/light_bg.png')] jusify-center items-center mx-1 border-[2px] border-gold overflow-hidden animate-fadeInOut" >
      ...
      <div className="lg:flex lg:flex-row">
        ...
        <div className=" lg:flex lg:w-[40%] bg-[url('/dark_bg.png')] py-2 flex-col items-center px-2 gap-0 bg-[200px] border-t-[2px] lg:border-t-0 lg:border-l-[2px]  border-gold">
          <div className="gap-1 flex justify-center items-center h-[120px] lg:mt-[70px] lg:flex-col">
